  ...
  return (
    <div className='about_us_page'>
      <div className='about_us_images'>
        <img className='about_us_images_image' src="/img/chainsaw.jpg" alt="Chainsaw"></img>
        <img className='about_us_images_image' src="/img/clock.jpg" alt="CLock"></img>
        <img className='about_us_images_image' src="/img/keys.jpg" alt="Keys"></img>
      </div>
