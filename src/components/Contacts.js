      ...
      <form className='contacts_form'>
        <div className='form_row'>
          <div className='form_field'>
            <label>{t('firstName')}</label><input type='text' placeholder=''></input>
          </div>
          <div className='form_field'>
            <label>{t('lastName')}</label><input type='text' placeholder=''></input>
          </div>
        </div>
        <div className='form_row'>
          <div className='form_field'>
            <label>{t('email')}</label><input type='email' placeholder=''></input>
          </div>
          <div className='form_field'>
            <label>{t('phoneNumber')}</label><input type='tel' placeholder=''></input>
          </div>
        </div>
        <div className='form_full-width '>
          <label>{t('message')}</label><textarea placeholder={t('writeMessage')} rows="3"></textarea>
        </div>
