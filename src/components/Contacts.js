    ...
    <div className='contacts'>
      <div className="presentation contacts_presentation">
        <div className="contacts_content">
          ...
          <p className='contacts_desc'>Write to us to find out more</p>
      ...
      <form className='contacts_form'>
        <div className='form_row'>
          <div className='form_field'>
            <label>First name</label><input type='text' placeholder=''></input>
          </div>
          <div className='form_field'>
            <label>Last name</label><input type='text' placeholder=''></input>
          </div>
        </div>
        <div className='form_row'>
          <div className='form_field'>
            <label>Email</label><input type='email' placeholder=''></input>
          </div>
          <div className='form_field'>
            <label>Phone Number</label><input type='tel' placeholder=''></input>
          </div>
        </div>
        <div className='form_full-width '>
          <label>Message</label><textarea placeholder="Write your message.." rows="3"></textarea>
        </div>
